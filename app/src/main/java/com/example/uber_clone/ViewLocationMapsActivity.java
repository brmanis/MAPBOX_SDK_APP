...
public class ViewLocationMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private Button btnGiveARideByDriver;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGiveARideByDriver=findViewById(R.id.btnConfirmRideByDriver);
        btnGiveARideByDriver.setText("I want to give " +getIntent().getStringExtra("rUsername") + " a ride!");
        btnGiveARideByDriver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                //Toast.makeText(ViewLocationMapsActivity.this, getIntent().getStringExtra("rUsername"), Toast.LENGTH_LONG).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
      ...
      LatLng pLocation = new LatLng(getIntent().getDoubleExtra("pLatitude",0),getIntent().getDoubleExtra("pLatitude",0));
